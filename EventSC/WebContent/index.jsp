...
<div id="Map">
	...
	<div id="Group_4">
		...
		<div id="Group_2">
			<div id="Group_1">
				<div id="USCCardinal">
					<svg class="USCCardinal_A0_Rectangle_3">
						<pattern elementId="USCCardinal_A0_Rectangle_4" id="USCCardinal_A0_Rectangle_4_pattern" x="0" y="0" width="100%" height="100%">
							<image x="0" y="0" width="100%" height="100%" href="USCCardinal_A0_Rectangle_4_pattern.png" xlink:href="USCCardinal_A0_Rectangle_4_pattern.png"></image>
						</pattern>
						<rect id="USCCardinal_A0_Rectangle_3" rx="0" ry="0" x="0" y="0" width="582" height="145">
						</rect>
					</svg>
				</div>
			</div>
	...
	<svg class="Rectangle_3">
		<pattern elementId="Rectangle_3_A0_Rectangle_7" id="Rectangle_3_A0_Rectangle_7_pattern" x="0" y="0" width="100%" height="100%">
			<image x="0" y="0" width="100%" height="100%" href="Rectangle_3_A0_Rectangle_7_pattern.png" xlink:href="Rectangle_3_A0_Rectangle_7_pattern.png"></image>
		</pattern>
		<rect id="Rectangle_3" rx="0" ry="0" x="0" y="0" width="1266" height="693">
		</rect>
	</svg>
	<div id="Group_7">
		...
		<div id="Group_6_A0_Group_8">
			...
			<svg class="iconfinder_plus_circle_2561291">
				<pattern elementId="iconfinder_plus_circle_2561291_A0_Rectangle_10" id="iconfinder_plus_circle_2561291_A0_Rectangle_10_pattern" x="0" y="0" width="100%" height="100%">
					<image x="0" y="0" width="100%" height="100%" href="iconfinder_plus_circle_2561291_A0_Rectangle_10_pattern.png" xlink:href="iconfinder_plus_circle_2561291_A0_Rectangle_10_pattern.png"></image>
				</pattern>
	...
	<div id="Group_9">
		...
		<svg class="Rectangle_5_A0_Rectangle_11">
			<rect id="Rectangle_5_A0_Rectangle_11" rx="0" ry="0" x="0" y="0" width="230.005" height="56.191">
			</rect>
		</svg>
		<div id="__Filter">
			<span>  Filter</span>
		...
		<svg class="iconfinder_filter_3325128">
			<pattern elementId="iconfinder_filter_3325128_A0_Rectangle_13" id="iconfinder_filter_3325128_A0_Rectangle_13_pattern" x="0" y="0" width="100%" height="100%">
				<image x="0" y="0" width="100%" height="100%" href="iconfinder_filter_3325128_A0_Rectangle_13_pattern.png" xlink:href="iconfinder_filter_3325128_A0_Rectangle_13_pattern.png"></image>
			</pattern>
	...
	<div id="Group_11">
		...
		<svg class="iconfinder_menu_24_103174">
			<pattern elementId="iconfinder_menu_24_103174_A0_Rectangle_16" id="iconfinder_menu_24_103174_A0_Rectangle_16_pattern" x="0" y="0" width="100%" height="100%">
				<image x="0" y="0" width="100%" height="100%" href="iconfinder_menu_24_103174_A0_Rectangle_16_pattern.png" xlink:href="iconfinder_menu_24_103174_A0_Rectangle_16_pattern.png"></image>
			</pattern>
			<rect id="iconfinder_menu_24_103174" rx="0" ry="0" x="0" y="0" width="41" height="41">
			</rect>
		</svg>
	</div>
</div>
